...
training = np.delete(training,500,0)
training = np.delete(training,24,1)
...
for i in range(0,npts,pvals):       # Do npts-pvals if the npts is not multiple of pvals
    if i == 0:
    ...
    elif i == range(0,npts,pvals)[-1]:  # Do npts-pvals if the npts is not multiple of pvals
